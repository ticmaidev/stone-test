    ...
    public void sendTransaction() {
        ...
        sendButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                transaction.setAmount(valueEditText.getText().toString());
                //Caso o cartão necessite assinatura, inserir o bitmap da assinatura aqui.
                transaction.setSignature(BitmapFactory.decodeResource(getResources(), R.drawable.signature));
                //Transação deve ser feita com captura imediata ou posterior
                transaction.setCapture(captureTransactionCheckBox.isChecked());
...
//                transaction.setInitiatorTransactionKey("SEU_IDENTIFICADOR_UNICO_AQUI");
                ...
                transaction.setInstalmentTransaction(InstalmentTransactionEnum.getAt(instalmentsSpinner.getSelectedItemPosition()));
                ...
                final TransactionProvider provider = new TransactionProvider(TransactionActivity.this, transaction, Stone.getUserModel(0), Stone.getPinpadFromListAt(0));
